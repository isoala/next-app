...
const Home = () => {
  ...
  return (
    ...
    <div className={cn(
      ...
      <div className="w-full md:w-[45%] pt-4 pl-10 pr-10 md:p-20 flex flex-col items-start md:top-10 md:mt-5 sm:sticky overflow-y-clip bg-gray-900"><div>
      ...
      <div className="w-full md:w-[55%] flex flex-col lg:h-screen overflow-y-auto overflow-x-hidden">
          <div className="p-10 space-y-12 space-x-10">
            ...
            <section id="school" className="space-y-4 bg-gray-900">
              <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen px-6 py-5 bg-gray-900 md:-mx-12 md:px-12 lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0">
            ...
            <section id="experience" className="space-y-2 bg-gray-900">
...
group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none ml-1 translate-y-px" aria-hidden="true"><path fillRule="evenodd" d="M5.22 14.78a.75.75 0 001.06 0l7.22-7.22v5.69a.75.75 0 001.5 0v-7.5a.75.75 0 00-.75-.75h-7.5a.75.75 0 000 1.5h5.69l-7.22 7.22a.75.75 0 000 1.06z" clipRule="evenodd"></path></svg></span></span>
            ...
            <section id="resume" className="space-y-4 bg-gray-900">
              <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen px-6 py-5 bg-gray-900 md:-mx-12 md:px-12 lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0">
            ...
            <section id="projects" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 bg-gray-900" aria-label="Selected projects">
              <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen px-6 py-5 bg-gray-900 md:-mx-12 md:px-12 lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0">
