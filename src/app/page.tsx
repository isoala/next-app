                      ...
                      <h3 className="font-medium leading-snug text-slate-200">
                        <div>
                          <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base" href="https://www.outamation.com/" target="_blank" rel="noreferrer noopener" aria-label="Outamation (opens in a new tab)">
                            ...
                            <span>AI Machine Learning Engineer Intern ·&nbsp;<span className="inline-block">Outamation<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="inline-block h-4 w-4 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group
